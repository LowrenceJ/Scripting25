...
document.getElementById("city").innerHTML =
  "You have " + builds + " buildings in your city";
//Functions --
...
function storageBuild() {
  console.log("Storage is functioning");
  builds++;
  document.getElementById("city").innerHTML =
    "You have " + builds + " buildings in your city";
...
function Apartment() {
  console.log("Apartment is functioning");
  builds++;
  document.getElementById("city").innerHTML =
    "You have " + builds + " buildings in your city";
  document.getElementById("cityGraphic").innerHTML +=
...
function Windows() {
  console.log("Windows is functioning");
  builds++;
  document.getElementById("city").innerHTML =
    "You have " + builds + " buildings in your city";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock3.png' alt='Windows'>";
}
//--------------------------------------------------------------------
function Garage() {
  console.log("Garage is functioning");
  builds++;
  document.getElementById("city").innerHTML =
    "You have " + builds + " buildings in your city";
  document.getElementById("cityGraphic").innerHTML +=
    "<img src='images/BuildingBlock4.png' alt='Garage'>";
}
